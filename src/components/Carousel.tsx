...
const Carousel: React.FC = () => {
    ...
    return (
        <section id="carousel" className="scroll-section items-center md:my-20 my-10 p-10 snap-start w-screen min-h-screen max-h-[120vh] flex-shrink-0 overflow-y-auto">
